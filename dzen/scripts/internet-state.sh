...
wifiState=$(cat /sys/class/net/wlp10s0/operstate)
ethernetState=$(cat /sys/class/net/eno1/operstate)
...
) | dzen2 -p -x 1098 -y 32 -w 350 -bg $BG -fg $FG -l 3 -sa l -ta c -e 'onstart=uncollapse;button1=exit;button3=exit' -fn $fn1
